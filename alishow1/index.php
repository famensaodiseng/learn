...
// (select count(*) from comments where post_id=p.id) commentsCount
// FROM posts p
...
//     // 执行sql语句
//   $postResult = mysqli_query($connect,$sql);//查询返回结果集不可以直接用，要用while循环

//   $postArr =[];
//   while ($row = mysqli_fetch_assoc($postResult)) {
//     $postArr[] = $row;//循环一次，取出一条数据追加到大数据
//   }
  // print_r($postArr);
    ...
    <div class="content">
      ...
      <div class="panel new">
        ...
        <?php  foreach ($postArr as $value) {?>
          ...
          <div class="main">
            <p class="info"><?php echo $value['nickname'] ?><?php echo $value['created'] ?></p>
